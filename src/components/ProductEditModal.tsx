...
const schema = z.object({
  ...
  // RHF will parse number via valueAsNumber; schema expects number (not unknown)
            ...
            <div className="w-full max-w-2xl overflow-hidden rounded-3xl border border-white/10 bg-[#0b0c10]/95 shadow-2xl">
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="grid gap-4 p-6 md:grid-cols-2">
                ...
                <div className="md:col-span-2">
                  <label className="mb-1 block text-sm font-medium text-zinc-200" htmlFor="title">
                    Title
                  </label>
                  <input
                    id="title"
                ...
                <div>
                  ...
                  <input
                    ...
                    type="number"
                    step="0.01"
                    // RHF parses to number here -> matches z.number() above
                ...
                {/* Category */}
                <div>
                  <label className="mb-1 block text-sm font-medium text-zinc-200" htmlFor="categoryId">
                    Category
                  </label>
                  <select
                    id="categoryId"
                ...
                {/* Image URL */}
                <div className="md:col-span-2">
                  <label className="mb-1 block text-sm font-medium text-zinc-200" htmlFor="imageUrl">
                    Image URL
                  </label>
                  <input
                    id="imageUrl"
